...
public class GameState extends State implements TouchListener, Observer{
	...
	private Font fnt;
	private int speedX;
	private OberservableClass ov = null;


	public GameState(OberservableClass ov) {
		this.ov = ov;
	...
	public void update(float dt) {
		...
		if(pingpongBall.getY()<paddle1.getY()-40){
			...
			countPlayer1++;
			this.speedX+=5;
			ov.setValue(countPlayer1, countPlayer2);
		}
	...
	public void update(Observable o, Object arg) {
		if (o == ov){
			System.out.println(ov.getScore1() +" "+ ov.getScore2());
		}
		System.out.println("Something changed: "+(String)arg);
